/**
 * Generates a random weight for a neural network using the He
 * initialization method.
 * 
 * The He initialization method is a widely used method for
 * initializing the weights of a neural network.
 * 
 * It is defined as W ~ U[-sqrt(6 / (n_in + n_out)), sqrt(6 / (n_in + n_out))],
 * where n_in and n_out are the number of inputs and outputs of the layer.
 * 
 ...
 */
export default function heWeight( fanIn: number, fanOut: number )
{
